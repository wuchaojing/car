  ...
  methods: {
        ...
        go: function () {
            ...
            for (var i = 0; i < msg.length; i++) {
                if(msg[i].photo) {
                    msg[i].pho = 'https://ss1.bdstatic.com/70cFvXSh_Q1YnxGkpoWK1HF6hhy/it/u=602076004,4209938077&fm=27&gp=0.jpg'
                } else {
                    msg[i].pho = ''
                }
                if(msg[i].finishPhoto) {
                    msg[i].finish = 'https://ss1.bdstatic.com/70cFvXSh_Q1YnxGkpoWK1HF6hhy/it/u=602076004,4209938077&fm=27&gp=0.jpg'
                }else {
                    msg[i].finish = ''
                }
                var data = {
        ...
        search: function () {
            ...
            for(var i=0;i<this.msg.length;i++) {
                if (this.msg[i].stateJudgement.indexOf(this.stateJudgement) != -1 && this.msg[i].problemClassification.indexOf(this.problemClassification) != -1 && this.msg[i].subdivisionType.indexOf(this.subdivisionType) != -1 && this.msg[i].rank.indexOf(this.rank) != -1 && this.msg[i].auditHierarchy.indexOf(this.auditHierarchy) != -1 && this.msg[i].repeatQuestion.indexOf(this.repeatQuestion) != -1 ) {
