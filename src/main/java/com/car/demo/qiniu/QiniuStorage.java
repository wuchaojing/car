...
public class QiniuStorage {
     ...
     * 上传PDF
     */
    public static String uploadPdf(byte[] file) {
        String key = QiniuKeyGenerator.generateKey();
        key = QiniuWrapper.uploadPdf(file, key, false);
        return key;
    }
     ...
     * 上传Excel
     */
    public static String uploadExcel(byte[] file) {
        String key = QiniuKeyGenerator.generateKey();
        key = QiniuWrapper.uploadExcel(file, key, false);
        return key;
    }
